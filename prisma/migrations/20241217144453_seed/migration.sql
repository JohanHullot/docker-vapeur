...
INSERT INTO "new_Game" ("description", "gameCategory", "gameEditor", "id", "inMainPage", "name", "nameOfImage", "publishDate") SELECT "description", "gameCategory", "gameEditor", "id", "inMainPage", "name", "nameOfImage", "publishDate" FROM "Game";
DROP TABLE "Game";
